    ...
    return(
        <SafeAreaView className="flex flex-1 items-start px-10  gap-8 justify-center bg-background-color">
            <View className="flex gap-3 flex-row items-start">
                <View style={{height:50,width:10}} className="rounded-md rotate-6 bg-[#b0961b]">

                </View>
                <View>
                    <Text className="text-xl font-semibold text-white">To Get Started Follow The following <Text className="text-[#b0961b]">Instructions</Text></Text>
                </View>
